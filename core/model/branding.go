...
// CreatedFrom/CreatedTo, when set, narrow to brandings created on or after
// / on or before that calendar date (inclusive on both ends). Page defaults
// to 1 and PageSize to BrandingDefaultPageSize when unset.
